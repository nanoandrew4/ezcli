...
public class FileAutocomplete {
    ...
    private static void fileNamesIterator() {
        ...
        if (newList) {
            for (String s : fileNames) {
                Ezcli.ezcliOutput.print(s, "file");
                Ezcli.ezcliOutput.print("\t", "files");
            }
        }
    ...
    protected static String getPath() {
        ...
        StringBuilder path = new StringBuilder(currText.startsWith("~") ? Ezcli.USER_HOME_DIR : "");
        ...
        for (int i = currText.length() - 1; i >= 0; i--) {
            if (currText.charAt(i) == '/') {
                ...
                path = new StringBuilder(Ezcli.currDir);
        }
